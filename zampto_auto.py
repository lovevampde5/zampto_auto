...
def login(page, max_retries=3) -> bool:
    ...
    for attempt in range(1, max_retries + 1):
        ...
        if wait_for_url_contains(page, "dash.zampto.net", 20) and "/auth/login" not in page.url:
        ...
        log.warning(f"登录后未正确跳转，检查账号密码或验证码拦截")
